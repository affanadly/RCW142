...
if __name__ == '__main__':
    ...
    ps.add_argument('--nchav', type=int, help='Number of channels to average', metavar='NCHAV', default=2)
    ps.add_argument('--cellsize', type=float, help='Cell size in arcseconds', metavar='CELLSIZE', default=1e-3)
    ps.add_argument('--imsize', type=int, help='Image size in pixels', metavar='IMSIZE', default=8192)
    ps.add_argument('--niter', type=int, help='Number of iterations', metavar='NITER', default=500)
